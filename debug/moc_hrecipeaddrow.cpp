...
void HRecipeAddRow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HRecipeAddRow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (HRecipeAddRow::*)(QList<QStandardItem*> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HRecipeAddRow::rowadded)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HRecipeAddRow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_HRecipeAddRow.data,
    qt_meta_data_HRecipeAddRow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
