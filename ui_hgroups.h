...
public:
    ...
    QLabel *label;
    QCheckBox *cbVistaFoglilavoro;
    QCheckBox *cbAggiornaFogliLavoro;
    ...
    void setupUi(QWidget *HGroups)
    {
        ...
        cbVistaFoglilavoro = new QCheckBox(HGroups);
        cbVistaFoglilavoro->setObjectName(QString::fromUtf8("cbVistaFoglilavoro"));

        gridLayout->addWidget(cbVistaFoglilavoro, 7, 1, 1, 1);

        cbAggiornaFogliLavoro = new QCheckBox(HGroups);
        cbAggiornaFogliLavoro->setObjectName(QString::fromUtf8("cbAggiornaFogliLavoro"));

        gridLayout->addWidget(cbAggiornaFogliLavoro, 7, 2, 1, 1);
        ...
        label_16 = new QLabel(HGroups);
        label_16->setObjectName(QString::fromUtf8("label_16"));

        gridLayout_2->addWidget(label_16, 7, 1, 1, 1);
    ...
    void retranslateUi(QWidget *HGroups)
    {
        ...
        label->setText(QCoreApplication::translate("HGroups", "Fogli lavoro:", nullptr));
        cbVistaFoglilavoro->setText(QCoreApplication::translate("HGroups", "Visualizzazione", nullptr));
        cbAggiornaFogliLavoro->setText(QCoreApplication::translate("HGroups", "Aggiornamento", nullptr));
