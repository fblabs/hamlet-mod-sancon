...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        toolButton->setPalette(palette5);
        QIcon icon6;
        ...
        pbVerifyLabels->setPalette(palette10);
        QIcon icon11;
        ...
        tbProdotti->setPalette(palette12);
        QIcon icon13;
        ...
        pbExpirations->setPalette(palette14);
        QIcon icon15;
        ...
        pbCalcoloCosti->setPalette(palette15);
        QIcon icon16;
        ...
        tbAssociazioni->setPalette(palette16);
        ...
        pbOldCards->setPalette(palette18);
        ...
        pbNotifiche->setPalette(palette20);
        QIcon icon19;
        ...
        pbContacts->setPalette(palette22);
        QIcon icon21;
        ...
        pbCkeckNotifications->setPalette(palette24);
        QIcon icon23;
        ...
        tbAnag->setPalette(palette25);
        QIcon icon24;
        icon24.addFile(QStringLiteral(":/Resources/Users64.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon25;
        icon25.addFile(QStringLiteral(":/Resources/Computer.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        tbSettings->setIcon(icon25);
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Hamlet MOD 2.6", 0));
        label_3->setText(QString());
        label_4->setText(QString());
        label->setText(QString());
        label_2->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600;\">Hamlet Mod 2.6</span></p><p><span style=\" font-size:16pt; font-weight:600;\">Versione: 2.6.0</span></p><p><br/></p><p><br/></p><p><span style=\" font-size:10pt; font-weight:600;\">Licenza:LGPL v. 3</span></p><p><span style=\" font-size:10pt; font-weight:600;\">Built with Qt 5.5.1 - MinGW 4.9.2</span></p><p><br/></p><p><br/></p><p><span style=\" font-size:10pt;\">\302\251 FBLABS 2015-2018</span></p><p><b><span style=\" text-decoration: underline; color:#aaffaa;\">Sorgenti (github)</span></b></p></body></html>", 0));
