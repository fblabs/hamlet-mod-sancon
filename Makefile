...
# Template: app
# Command: C:/Qt/5.5/mingw492_32/bin/qmake.exe -spec win32-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile hamletMOD.pro
#############################################################################
...
Makefile: hamletMOD.pro ../../Qt/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf ../../Qt/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile hamletMOD.pro
