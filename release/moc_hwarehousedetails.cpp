...
QT_MOC_LITERAL(7, 92, 13), // "updateAmounts"
QT_MOC_LITERAL(8, 106, 15), // "deleteOperation"
QT_MOC_LITERAL(9, 122, 27), // "on_leQuantita_returnPressed"
QT_MOC_LITERAL(10, 150, 19) // "on_pbDelete_clicked"

    },
    "HWarehouseDetails\0confirm\0\0getLotdefData\0"
    "on_pbSave_clicked\0on_pbClose_clicked\0"
    "saveOperation\0updateAmounts\0deleteOperation\0"
    "on_leQuantita_returnPressed\0"
    "on_pbDelete_clicked"
};
...
void HWarehouseDetails::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HWarehouseDetails *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 5: _t->updateAmounts(); break;
        case 6: _t->deleteOperation(); break;
        case 7: _t->on_leQuantita_returnPressed(); break;
        ...
        {
            using _t = void (HWarehouseDetails::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HWarehouseDetails::confirm)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HWarehouseDetails::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_HWarehouseDetails.data,
    qt_meta_data_HWarehouseDetails,
    qt_static_metacall,
    nullptr,
    nullptr
} };
