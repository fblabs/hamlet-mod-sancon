...
QT_MOC_LITERAL(4, 52, 14), // "sig_add_recipe"
QT_MOC_LITERAL(5, 67, 11), // "id_prodotto"
QT_MOC_LITERAL(6, 79, 12), // "get_products"
QT_MOC_LITERAL(7, 92, 24), // "on_pbCreaRicetta_clicked"
QT_MOC_LITERAL(8, 117, 32), // "on_pbAddRecipeAndproduct_clicked"
QT_MOC_LITERAL(9, 150, 32), // "on_leSearchProduct_returnPressed"
QT_MOC_LITERAL(10, 183, 18), // "on_pbClose_clicked"
QT_MOC_LITERAL(11, 202, 18), // "on_cb_what_toggled"
QT_MOC_LITERAL(12, 221, 7) // "checked"

    },
    "HNew_recipe_main\0sig_add_recipe_and_product\0"
    "\0p_tipo\0sig_add_recipe\0id_prodotto\0"
    "get_products\0on_pbCreaRicetta_clicked\0"
...
static const uint qt_meta_data_HNew_recipe_main[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       4,    0,   65,    2, 0x26 /* Public | MethodCloned */,
...
void HNew_recipe_main::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sig_add_recipe((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 2: _t->sig_add_recipe(); break;
        case 3: _t->get_products(); break;
        case 4: _t->on_pbCreaRicetta_clicked(); break;
        case 5: _t->on_pbAddRecipeAndproduct_clicked(); break;
        case 6: _t->on_leSearchProduct_returnPressed(); break;
        case 7: _t->on_pbClose_clicked(); break;
        case 8: _t->on_cb_what_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (HNew_recipe_main::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HNew_recipe_main::sig_add_recipe)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void HNew_recipe_main::sig_add_recipe(const int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
