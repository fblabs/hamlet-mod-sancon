...
void HDuplicate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HDuplicate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (HDuplicate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HDuplicate::update)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HDuplicate::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_HDuplicate.data,
    qt_meta_data_HDuplicate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
