...
QT_MOC_LITERAL(5, 56, 15), // "addNewContainer"
QT_MOC_LITERAL(6, 72, 4), // "p_id"
QT_MOC_LITERAL(7, 77, 17), // "on_pbSave_clicked"
QT_MOC_LITERAL(8, 95, 19) // "on_pbCancel_clicked"

    },
    "HNewProduct\0done\0\0on_pushButton_2_clicked\0"
    "addNewProduct\0addNewContainer\0p_id\0"
...
void HNewProduct::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HNewProduct *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->done(); break;
        case 1: _t->on_pushButton_2_clicked(); break;
        case 2: _t->addNewProduct(); break;
        case 3: { bool _r = _t->addNewContainer((*reinterpret_cast< const int(*)>(_a[1])));
        ...
        {
            using _t = void (HNewProduct::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HNewProduct::done)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HNewProduct::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_HNewProduct.data,
    qt_meta_data_HNewProduct,
    qt_static_metacall,
    nullptr,
    nullptr
} };
