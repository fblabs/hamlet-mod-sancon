...
void HGraphicPrint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HGraphicPrint *_t = static_cast<HGraphicPrint *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject HGraphicPrint::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HGraphicPrint.data,
      qt_meta_data_HGraphicPrint,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HGraphicPrint::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HGraphicPrint.stringdata0))
        return static_cast<void*>(const_cast< HGraphicPrint*>(this));
