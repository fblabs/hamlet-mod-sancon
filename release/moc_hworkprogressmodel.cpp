...
const QMetaObject HWorkProgressModel::staticMetaObject = {
    { &QSqlRelationalTableModel::staticMetaObject, qt_meta_stringdata_HWorkProgressModel.data,
      qt_meta_data_HWorkProgressModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HWorkProgressModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HWorkProgressModel.stringdata0))
        return static_cast<void*>(const_cast< HWorkProgressModel*>(this));
