/********************************************************************************
** Form generated from reading UI file 'hcalcolo_costi_item_set_copy.ui'
**
...
#ifndef UI_HCALCOLO_COSTI_ITEM_SET_COPY_H
#define UI_HCALCOLO_COSTI_ITEM_SET_COPY_H
...
public:
    ...
    void setupUi(QWidget *HCalcolo_costi_item)
    {
        ...
        HCalcolo_costi_item->resize(400, 209);
        ...
        pbOk = new QPushButton(HCalcolo_costi_item);
        ...
        pbClose = new QPushButton(HCalcolo_costi_item);
    ...
    {
        HCalcolo_costi_item->setWindowTitle(QCoreApplication::translate("HCalcolo_costi_item", "SET item", nullptr));
        ...
        pbOk->setText(QCoreApplication::translate("HCalcolo_costi_item", "OK", nullptr));
        pbClose->setText(QCoreApplication::translate("HCalcolo_costi_item", "Chiudi", nullptr));
    } // retranslateUi
...
#endif // UI_HCALCOLO_COSTI_ITEM_SET_COPY_H
